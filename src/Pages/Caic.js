   ...
   return (
      <div className='body_wrapper'>
         ...
         <BreadcrumbServ
            ...
            imgServ='new-home/caic.png'
            Ptitle='Centro de Asistencia Infantil Comunitario (CAIC)'
            Pdescription=''
         />
            ...
            <div className='features_info text-center responsivomovil'>
               ...
               <div>
                  <p className='text-justify'>
                     CAIC tiene como objetivo proporciona protección y formación
                     general a un mayor número de niñas y niños entre 2 y 5 años
                     a 11 meses que se encuentran en situaciones de
                     vulnerabilidad, a través de acciones educativas y
                     asistenciales que proporcione la interacción con la
                     familia, con la sociedad y con su ambiente, para que logren
                     en un futuro integrarse en condiciones favorables a los
