   ...
   return (
      <div className='body_wrapper'>
         ...
         <Breadcrumb
            ...
            Ptitle='Transparencia'
            Pdescription=''
         />
         {/**esta es la parte del banner */}
         ...
         <div className='container process_area  sec_pad pl-30 pr-30 mt_90 mb_90'>
            <div className='features_info text-center responsivomovil'>
               ...
               <div>
                  <p>
                     La información materia de este ordenamiento es un bien del
                     dominio público, cuya titularidad reside en la sociedad,
                     misma que tendrá en todo momento la facultad de disponer de
                     ella para los fines que considere sin necesidad de que
                     alguna persona la solicite. Este atendimiento a lo señalado
                     en los artículos 8 y 15 de la Ley de Transparencia y Acceso
