            ...
            <div className='features_info text-center responsivomovil'>
               ...
               <div>
                  <p className='text-center'>
                     Preocupados por atender y dar seguimiento a cada una de las
                     necesidades de los integrantes de nuestra población, DIF
                     Jocotepec pone a su servicio la atención psicológica con el
                     propósito de acompañar y valorar los comportamientos
                     cognoscitivos y afectivos del ser humano, tanto en el
                     ámbito individual como social, desde una perspectiva
                     transdisciplinar y centrado en el bienestar personal y
               ...
               <table className='table table-borderless mt-5 m-auto'>
                  ...
                  <tbody>
                     <tr>
                        <td>Consulta</td>
                        <td>
                           $100.00 mxn (individual) <br />
                           $50.00 mxn p/p (familiar)
                        </td>
                     </tr>
                     ...
                     <tr>
                        <td>Escucha de menores</td>
                        <td>$1,000.00 mxn</td>
                     </tr>

                     <tr>
                        <td>Valoración Cognitiva</td>
                        <td>$500.00 mxn</td>
                     </tr>

                     <tr>
                        <td>Valoración para trámites ante juzgado</td>
                        <td>$700.00 mxn</td>
                     </tr>
                  </tbody>
               </table>
