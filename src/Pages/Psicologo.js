...
const Psicologo = () => {
    return(
        <div className="body_wrapper">
            ...
            {/* <Breadcrumb breadcrumbClass="breadcrumb_area" imgName="breadcrumb/banner_bg.png" Ptitle="Psicología" Pdescription=""/> */}
            <BreadcrumbServ breadcrumbClass="breadcrumb_area" imgName="breadcrumb/banner_bg.png" Ptitle="Psicología" Pdescription="" imgServ="home4/psicologo.png" />
            ...
            <div className='container process_area  sec_pad pl-30 pr-30 mt_90 mb_20'>
                <div className='features_info text-center responsivomovil'>
                    ...
                    <div>
                        <p className='text-center'>Preocupados por atender y dar seguimiento a cada una de las necesidades de los integrantes de nuestra población, DIF Jocotepec pone a su servicio la atención psicológica con el propósito de acompañar y valorar los comportamientos cognoscitivos y afectivos del ser humano, tanto en el ámbito individual como social, desde una perspectiva transdisciplinar y centrado en el bienestar personal y colectivo de los individuos.</p>
                    </div>
                </div>
            </div>
            ...
            <div className='container process_area  sec_pad pl-30 pr-30 mt_20 mb_90'>
                ...
                <h2>Horario:</h2>
                <p>Lunes a Viernes de 9:00 a 15:00 horas, (previa cita)</p>
                <h2>Teléfono:</h2>
