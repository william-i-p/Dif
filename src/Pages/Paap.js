           ...
           {/*  <Breadcrumb breadcrumbClass="breadcrumb_area" imgName="breadcrumb/banner_bg.png" Ptitle="Programa de Asistencia Alimentaria a Personas de Atención Prioritaria (PAAP)" Pdescription=""/> */}
            ...
            <div className='container process_area  sec_pad pl-30 pr-30 mt_90 mb_20'>
                <div className='features_info text-center responsivomovil'>
                    ...
                    <div>
                        <p className='text-justify'>Centrandose en la entrega de apoyo alimentario a la población con calidad nutrimental acompañados con acciones de difusión y orientación alimentaria e higienica con el fin de mejorar y apoyar a que la población mejore sus hábitos y con ello prevenir enfermedades crónico degenerativas.</p>
                    </div>
                </div>
            </div>
            ...
            <div className='container process_area  sec_pad pl-30 pr-30 mt_20 mb_20'>
                <div className='features_info text-center responsivomovil'>
                <h3>Este programa se especializa en atención<br/>a 3 sectores de la población:</h3>
                <p>1. Niñas y Niños de 2 a 5 años no escolarizados</p>
                <p>2. Adultos Mayores de 60 años</p>
                <p>3. Personas en situación de carencia alimentaria o desnutrición y discapacitados.</p>
                </div>
            </div>
            <div className='container process_area  sec_pad pl-30 pr-30 mt_20 mb_20'>
            <div className='features_info text-center responsivomovil'>
            <h3>REQUISITOS:</h3>
                ...
                <p className='text-center'>*Las listas de los beneficiarios serán publicadas por medios electrónicos, de manera física en las oficinas centrales de DIF Jocotepec y en las delegaciones.</p>            
            </div>
            </div>
            ...
            <div className='container process_area  sec_pad pl-30 pr-30 mt_30 mb_90'>
                <div className='features_info text-center responsivomovil'>
